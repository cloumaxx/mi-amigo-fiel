...
class PantRegisMiemb extends StatefulWidget {
  PantRegisMiemb({Key key, this.title}) : super(key: key);
  final String title;
  @override
  _PantRegisMiembState createState() => _PantRegisMiembState();
}

//******************************************************************************************************

class _PantRegisMiembState extends State<PantRegisMiemb> {
        ...
        children: [
          ...
          Container(
            ...
            child: TextField(
              ...
              obscureText: false,
              decoration: InputDecoration(
                  labelText: '¿Que cargo tendra?',
                  hintText: 'Escribe el cargo'),
            ),
          ),
          SizedBox(height: 40),
          Container(
